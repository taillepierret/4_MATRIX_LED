...
const int P[hauteur_matrice] = {0x78, 0x7C, 0x66, 0x66, 0x7C, 0x78, 0x60, 0x60} ;
const int Q[hauteur_matrice] = {0x3C, 0x7E, 0x66, 0x66, 0x7E, 0x3C, 0x0C, 0x06} ;
const int R[hauteur_matrice] = {0x3C, 0x7E, 0x66, 0x66, 0x7C, 0x7C, 0x6E, 0x66} ;
const int S[hauteur_matrice] = {0x3E, 0x7E, 0x60, 0x7C, 0x3E, 0x06, 0x7E, 0x7C} ;
...
const int V[hauteur_matrice] = {0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x3C, 0x18} ;
const int W[hauteur_matrice] = {0xC3, 0xC3, 0xC3, 0xC3, 0xDB, 0xFF, 0x7E, 0x66} ;
const int X[hauteur_matrice] = {0x66, 0x66, 0x66, 0x3C, 0x3C, 0x66, 0x66, 0x66} ;
const int Y[hauteur_matrice] = {0x66, 0x66, 0x7E, 0x3C, 0x18, 0x18, 0x18, 0x18} ;
const int Z[hauteur_matrice] = {0x7E, 0x7E, 0x06, 0x1E, 0x78, 0x60, 0x7E, 0x7E} ;
